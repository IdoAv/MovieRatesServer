...
namespace MovieRatesServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connectionString = this.Configuration.GetConnectionString("MovieRatesDB");

            services.AddDbContext<MovieRatesDBContext>(options => options
